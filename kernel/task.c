...
ktask_t *k_create_task ( void *start_func, void *param, void *exit_func, uint32_t stack_size, page_directory_t *task_page_dir){
   ...
   arch_create_thread_context( &(new_task->context), start_func, param,
...
ktask_t *k_create_userland_task ( void *start_func, void *param, void *exit_func, uint32_t stack_size, page_directory_t *task_page_dir){
   ...
   arch_create_userland_thread( &(new_task->context), start_func, param,
                                exit_func, stack, stack_size );
