...
void move_cursor(int x, int y){
   ...
   port_byte_out(REG_SCREEN_CTRL, 14);
   port_byte_out(REG_SCREEN_DATA, tmp >> 8); //send upper bits
   port_byte_out(REG_SCREEN_CTRL, 15);
   port_byte_out(REG_SCREEN_DATA, tmp);      //send lower bits
...
void move_cursorl(int position){
   ...
   //with the high and low bytes to set.
   port_byte_out(REG_SCREEN_CTRL, 14);
   port_byte_out(REG_SCREEN_DATA, position >> 8); //send upper bits
   port_byte_out(REG_SCREEN_CTRL, 15);
   port_byte_out(REG_SCREEN_DATA, position);      //send lower bits
